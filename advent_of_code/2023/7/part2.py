...
replacement_dict = {'A':'a', 'K':'b', 'Q':'c', 'J':'d', 'T':'e', '9':'f', '8':'g', '7':'h', '6':'i', '5':'j', '4':'k', '3':'l', '2':'m', 'J': 'n'}
...
def sort_card(a,b):
    ...
    print(counter1)
    print(counter2)
    if 'J' in counter1 and counter1['J'] != 5:
        value = counter1['J']
        print(counter1)
        del counter1['J']
        print(counter1)
        counter1[max(counter1,key=counter1.get)] += value

    if 'J' in counter2 and counter2['J'] != 5:
        value = counter2['J']
        del counter2['J']
        counter2[max(counter2,key=counter2.get)] += value
